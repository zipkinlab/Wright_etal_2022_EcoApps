...
## Code: Data simulation and analysis for the Random Stratified case study
...
## Looping Variables
start <- 1
end <- 10 #Run this script 65 times in HPCC for a total of 650 sims: for i in {1..65}; do sbatch amphibianRS.sb; done
